...
class TalkCommunityTab extends StatefulWidget {
  final bool isUpdateData;
  final bool isLogin;
  const TalkCommunityTab({Key key, this.isUpdateData, this.isLogin})
      : super(key: key);

  @override
  _TalkCommunityTabState createState() => _TalkCommunityTabState();
}

class _TalkCommunityTabState extends State<TalkCommunityTab> {
  ...
  void initState() {
    ...
    pageNo = 1;
    images = [
      'assets/images/community/com-banner-4.png',
  ...
  @override
  void didUpdateWidget(TalkCommunityTab oldWidget) {
          ...
          Positioned(
            ...
            child: Padding(
              padding: const EdgeInsets.only(
                  top: 2.0, left: 10, right: 10, bottom: 10),
              child: Row(
...
//                    ),
                                ...
                                children: <Widget>[
                                  InkWell(
                                    onTap: () {
                                      setState(() {
                                        isPopularTab = true;
                                        orderTypeId = CommunityListOrderType
                                            .Popular.index;
                                        setState(() {
                                          isNoMoreData = false;
                                          pageNo = 1;
                                  ...
                                  InkWell(
                                    onTap: () {
                                      setState(() {
                                        isPopularTab = false;
                                        orderTypeId =
                                            CommunityListOrderType.Recent.index;
                                        setState(() {
                                          isNoMoreData = false;
                                          pageNo = 1;
                                          isPaging = false;
  ...
  Widget getForumView(BuildContext context, int index) {
    return InkWell(
        ...
        child: ForumListView( 
          id:isPopularTab==true?1:2,pic: true,
        communityListData: null, index: index, isSearch: !isPopularTab)
...
//          .apiRepos
//          .communityListRequest(context, roleId,CategoryListId.Talk.index,subCategoryId??0,orderTypeId,pageNo,!isPaging);
