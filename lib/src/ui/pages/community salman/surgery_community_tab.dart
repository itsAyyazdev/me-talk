...
class SurgeryCommunityTab extends StatefulWidget {
  final bool isUpdateData;
  final bool isLogin;
  const SurgeryCommunityTab({Key key, this.isUpdateData, this.isLogin})
      : super(key: key);

  @override
  _SurgeryCommunityTabState createState() => _SurgeryCommunityTabState();
}

class _SurgeryCommunityTabState extends State<SurgeryCommunityTab> {
  ...
  void dispose() {
    ...
    super.dispose();
    print('dispose called _Surgery');
  }

  @override
  void didUpdateWidget(SurgeryCommunityTab oldWidget) {
...
//          .apiRepos
//          .communityListRequest(context, roleId,CategoryListId.Surgery.index,subCategoryId??0,orderTypeId,pageNo,true);
